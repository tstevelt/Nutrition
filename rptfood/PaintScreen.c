...
void PaintScreen ()
{
	...
	printf ("<td>\n" );
	printf ("<select name='Universe' id='Universe'>\n" );
	...
	printf ( "<tr>\n" );
	printf ( "<td>Sort by</td>\n" );
	printf ( "<td>\n" );
	printf ( "<select name='SortBy'>\n" );
	printf ( "<option value='N'>Name</option>\n" );
	printf ( "<option value='C'>Calories</option>\n" );
	printf ( "<option value='P'>Protein</option>\n" );
	printf ( "<option value='F'>Fiber</option>\n" );
	printf ( "<option value='D'>Protein Density</option>\n" );
	printf ( "</select>\n" );
	printf ( "</td>\n" );
	printf ( "</tr>\n" );
