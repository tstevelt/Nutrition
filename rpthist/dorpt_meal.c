...
#define		MAXTOKS		10
	...
	ReportTotals[1] = ColumnArray[1].Total.longTotal[1];
	ReportTotals[2] = ColumnArray[2].Total.longTotal[1];
	ReportTotals[3] = ColumnArray[3].Total.longTotal[1];
	ReportTotals[4] = ColumnArray[4].Total.longTotal[1];
	ReportTotals[5] = ColumnArray[5].Total.longTotal[1];
	ReportTotals[6] = ColumnArray[6].Total.doubleTotal[1];
	...
	sprintf ( xbuffer, "%s|%d|%d|%d|%d|%d|%d|%.2f",
		// tokens[0], tokens[1],
		"TARGET",
	...
	sprintf ( xbuffer, "%s|%.0f|%.0f|%.0f|%.0f|%.0f|%.0f| ",
		// tokens[0], tokens[1],
		"PERCENT",
