...
#define		MAXTOKS		10
	...
	ReportTotals[1] = ColumnArray[1].Total.longTotal[0];
	ReportTotals[2] = ColumnArray[2].Total.longTotal[0];
	ReportTotals[3] = ColumnArray[3].Total.longTotal[0];
	ReportTotals[4] = ColumnArray[4].Total.longTotal[0];
	ReportTotals[5] = ColumnArray[5].Total.longTotal[0];
	ReportTotals[6] = ColumnArray[6].Total.doubleTotal[0];

	rpttotal ( &ReportOptions, ColumnArray, ColumnCount, 0 );

	sprintf ( xbuffer, "TARGET|%d|%d|%d|%d|%d|%d|%.2f",
	...
	sprintf ( xbuffer, "PERCENT|%.0f|%.0f|%.0f|%.0f|%.0f|%.0f| ",
